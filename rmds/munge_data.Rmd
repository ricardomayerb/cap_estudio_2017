...
```{r monetary_fin, message=FALSE, warning=FALSE}
library(tidyverse)
library(stringr)
library(countrycode)
...
## KLEMS project data for ARG, BRZ, CHL, COL, MEX

Quantitative data is in QS files. Metadata in Contents and Definitions files

```{r klems, message=FALSE, warning=FALSE}
library(tidyverse)
library(stringr)
library(lubridate)
library(countrycode)
...
## Self-employment data, EDD

```{r tcp, message=FALSE, warning=FALSE}
library(tidyverse)
library(countrycode)
...
## Trade by countries and products

By origin and destination, and by grou pf products

```{r x_m_ori_prod, message=FALSE, warning=FALSE}
library(tidyverse)
library(countrycode)
library(stringr)
