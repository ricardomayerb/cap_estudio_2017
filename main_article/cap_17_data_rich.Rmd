...
#   new_df <- df %>% 
#   select(iso3c, date, value, ranking, quartile, half,  ranking_3, quartile_3, half_3,
#          avg_recent3, avg_last3, hp_cycle_pct, hp_trend, diff_lastval, diff_avg3) 
#   
...
dom_fin_df_2006 <- dom_fin_df %>%
  filter(year(date) %in% c(2006)) %>% arrange(desc(avg_recent3_dcpri)) 

dom_fin_df_2007 <- dom_fin_df %>%
  filter(year(date) %in% c(2007)) %>%arrange(desc(avg_recent3_dcpri))

dom_fin_df_2015 <- dom_fin_df %>%
  filter(year(date) %in% c(2015)) %>% arrange(desc(avg_recent3_dcpri))

foo <- data.frame(avg_0406 = dom_fin_df_2006$avg_recent3_dcpri,
                  avg_1416 = dom_fin_df_2006$avg_last3_dcpri,
                  ran_06 = dom_fin_df_2006$ranking_dcpri,
                  qth_0406 = dom_fin_df_2006$quartile_recent3_dcpri,
                  qth_1416 = dom_fin_df_2006$quartile_last3_dcpri,
                  ran_0406 = dom_fin_df_2006$ranking_recent3_dcpri,
                  ran_1416 = dom_fin_df_2006$ranking_last3_dcpri,
                  row.names =  dom_fin_df_2006$iso3c) 

wfoo <- with(dom_fin_df_2006, data.frame(avg_0406 = avg_recent3_dcpri,
                  avg_1416 = avg_last3_dcpri,
                  ran_06 = ranking_dcpri,
                  qth_0406 = quartile_recent3_dcpri,
                  qth_1406 = quartile_last3_dcpri,
                  ran_0406 = ranking_recent3_dcpri,
                  ran_1406 = ranking_last3_dcpri,
                  row.names =  iso3c) )

goo  <- with(dom_fin_df_2006, data.frame(country = iso3c, avg_0406 = avg_recent3_dcpri,
                  avg_1416 = avg_last3_dcpri,
                  qth_0406 = quartile_recent3_dcpri,
                  qth_1406 = quartile_last3_dcpri,
                  ran_0406 = ranking_recent3_dcpri,
...
moo  <- with(dom_fin_df_2006, data.frame(country = iso3c, avg_0406 = avg_recent3_dcpri,
                  avg_1416 = avg_last3_dcpri,
                  qth_0406 = quartile_recent3_dcpri,
                  d_qth = quartile_last3_dcpri - quartile_recent3_dcpri,
                  ran_0406 = ranking_recent3_dcpri,
                  d_ran = ranking_last3_dcpri - ranking_recent3_dcpri ))
