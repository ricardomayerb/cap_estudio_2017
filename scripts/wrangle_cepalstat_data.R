...
save(cs_real_dolares_20, file = "cs_real_dolares_20")
save(cs_financiero_monetario_20, file = "cs_financiero_monetario_20")
save(cs_remuneraciones_20, file = "cs_remuneraciones_20")
save(cs_empleo_20, file = "cs_empleo_20")
save(cs_desempleo_20, file = "cs_desempleo_20")
save(cs_bp_anual_20, file = "cs_bp_anual_20")
save(cs_bp_trimestral_20, file = "cs_bp_trimestral_20")
save(cs_deuda_externa_20, file = "cs_deuda_externa_20")
save(cs_indicadores_bp_20, file = "cs_indicadores_bp_20")
save(cs_sector_publico_20, file = "cs_sector_publico_20")
save(cs_comercio_intrarregional_20, file = "cs_comercio_intrarregional_20")
save(cs_x_m_gran_cat_20, file = "cs_x_m_gran_cat_20")
save(cs_x_m_10_ppales_20, file = "cs_x_m_10_ppales_20")
save(cs_x_m_servicios_20, file = "cs_x_m_servicios_20")
save(cs_x_m_total_mensual_20, file = "cs_x_m_total_mensual_20")
save(cs_x_prim_manuf_20, file = "cs_x_prim_manuf_20")
save(cs_tipo_cambio_20, file = "cs_tipo_cambio_20")
save(cs_x_m_vol_precios_20, file = "cs_x_m_vol_precios_20")
