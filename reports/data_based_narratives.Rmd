...
gobcen_deuda_tot_xts <- cate_gen_to_xts_wide(gobcen_deuda_18 %>% select(iso3c, year, total_p), 
                                            is_full = TRUE, is_med = FALSE, value_col = "total_p")

gobcen_deuda_dom_xts <- cate_dext_to_xts_wide(gobcen_deuda_18[["interna_p"]], 
                                            is_full = TRUE, is_med = FALSE)

gobcen_deuda_dom_xts <- cate_dext_to_xts_wide(gobcen_deuda_18[["externa_p"]], 
                                            is_full = TRUE, is_med = FALSE)
