...
<!-- ```{r dext_make_dygraph_bmv} -->

<!-- dext_to_gdp_bmv_xts <- cbind.xts(dext_to_gdp_sa_xts[ ,"BRA"], -->
<!--                      dext_to_gdp_ca_xts[ ,"MEX"], -->
<!--                      dext_to_gdp_sa_xts[ ,"VEN"]) -->

<!-- dext_title_bmv <- "(Gross) External debt, as % of GDP (BMV)" -->

<!-- dg_bmv <- dygraph(dext_to_gdp_bmv_xts, main = dext_title_bmv) %>% -->
<!--   dyRangeSelector() %>% -->
<!--   dyHighlight(highlightCircleSize = 4,  -->
<!--               highlightSeriesBackgroundAlpha = 0.3, -->
<!--               hideOnMouseOut = FALSE) -->
...
# dext_to_gdp_18_aug <-  dext_to_gdp_18 %>% 
#   mutate(g_median_1990_2001 = if_else(deuda_ext_porc_pib > pctiles_50_1990_2001,
#                                       "High", "Low"))
